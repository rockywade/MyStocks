...
Ext.onReady(function(){
	...
	var SecondBookStoreJudgeObj = [
	   	...
	   	var store = new Ext.data.JsonStore({
	   		 id :"store",
	   		 url: 'secondBookStoreJudge_findPageSecondBookStoreJudge.do?storeid='+document.getElementById("id").value,
	   		 root: 'root',
	   		 totalProperty: 'total',
    ...
    var deleteJudge = function(grid, rowIndex, colIndex){
    	...
    	Ext.MessageBox.confirm('删除提示', '是否删除该评论？', function(c) {
		   	Ext.Ajax.request({
		   			url : "secondBookStoreJudge_delete.do",
	...
	bt.on("click", function(){
		Ext.Ajax.request({
   			url : "secondBookStoreJudge_saveOrUpdateSecondBookStoreJudge.do",
   			params:{
