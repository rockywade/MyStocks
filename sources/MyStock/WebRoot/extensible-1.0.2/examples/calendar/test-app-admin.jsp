...
<head>
<meta charset="utf-8" />
<title>Extensible Calendar App</title>
<!-- Sets up all Ext and Extensible includes: -->
<script type="text/javascript" src="../../Extensible-config-admin.js"></script>
...
<script type="text/javascript" src="test-app-admin.js"></script>
<script type="text/javascript" src="ext-locales/ext-lang-zh_CN.js"></script>
<!--<script type="text/javascript" src="ext-locales/extensible-lang-zh_CN.js"></script>-->
